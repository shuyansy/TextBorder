...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--num_workers', default=16, type=int, help='Number of workers used in dataloading')
        ...
        # eval args
        self.parser.add_argument('--checkepoch', default=755, type=int, help='Load checkpoint number')  #110, 220
        ...
        self.parser.add_argument('--tcl', default=0.5, type=float, help='tcl')
        self.parser.add_argument('--kernel', default=0.6, type=float, help='kernel')
