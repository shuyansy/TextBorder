...
eval_result_dir = '/home/uircv/桌面/cv/ocr/DRRG_syn/output/Analysis/output_eval'
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    with open(fid_path, 'w') as f:
        for resFile in tqdm(gt):
            ...
            # write result
            f.write('%s :: Precision=%.4f - Recall=%.4f\n' % (str(resFile) + ".txt", recall, precision))
...
import os
import zipfile
def eval_td(res_folder):
    params={}
    current_folder='/home/uircv/桌面/cv/ocr/DRRG_syn/dataset/TD500/Evaluation_Protocol'
...
def getresult():
    eval_td('/home/uircv/桌面/cv/ocr/DRRG_syn/output/TD500')
